...
用法：
    # 测试5只股票
    python src/stock_ana/research/us_software_analysis/analyze_v2.py --test
    python src/stock_ana/research/us_software_analysis/analyze_v2.py --test --tickers ADBE DDOG FROG VEEV CRM

    # 全量运行（18组）
    python src/stock_ana/research/us_software_analysis/analyze_v2.py
    python src/stock_ana/research/us_software_analysis/analyze_v2.py --resume   # 断点续传
"""
