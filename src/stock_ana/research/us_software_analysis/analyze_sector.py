...
用法：
    python src/stock_ana/research/us_software_analysis/analyze_sector.py
    python src/stock_ana/research/us_software_analysis/analyze_sector.py --resume  # 跳过已有结果的组
"""
