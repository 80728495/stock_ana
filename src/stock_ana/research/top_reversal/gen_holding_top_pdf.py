...
用法：
    python src/stock_ana/research/top_reversal/gen_holding_top_pdf.py                 # 近10交易日, top30%档
    python src/stock_ana/research/top_reversal/gen_holding_top_pdf.py --days 5 --band top9
"""
