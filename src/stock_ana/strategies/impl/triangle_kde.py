...
from stock_ana.strategies.primitives import argrel_pivots, check_trend_template, ols_fit
...
def screen_ascending_triangle_kde(
    ...
    hi_idx, lo_idx = argrel_pivots(highs_arr, lows_arr, order=order)
    ...
    for period in range(min_period, min(max_period + 1, n + 1), 5):
        ...
        ss, si, sr2, s_max_res = ols_fit(wl_rel, wl_vals)
